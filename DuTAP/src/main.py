...
from utils.tools import label_from_mat
from dataset import FNIRSData, ExtendFNIRSData
from train import train
import random
import numpy as np
from torch.utils.data import DataLoader
from model import DuTAP
import os
...
data_path = root_path + '/data/extend'
...
def main():
    ...
    dataset_train = ExtendFNIRSData(data_path, 'train')
    dataset_test = ExtendFNIRSData(data_path, 'test')
    ...
    model = DuTAP(n_class=2, channels=53).to('cuda')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint_name', type=str, default='2025-01-01_937.pth', help='model path')
